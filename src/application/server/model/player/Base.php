...
abstract class M_Player_Base extends M_DBModel {
    ...
    public function initWithID($id) {
        try {$result = C_Database_SQL::executeSQL(self::$_dbo, C_Database_SQL::getSelectQuery1Where1Limit("*", "playeraccounts", "playerID", 1, "playerID"), array($id));}
    ...
    public function updateSelf($newFieldsArray) {
        $query = C_Database_SQL::getUpdateQuery1Where(array_keys($newFieldsArray), "playeraccountts", count($newFieldsArray), "playerID");
        print($query);
